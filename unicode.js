...
// let firstCodePoint = inputString1.charAt(0); // Your code here
// let thirdCodePoint = inputString1.charAt(2); // Your code here
...
let characters = String.fromCharCode(wordFromCodePoints[0]) +  String.fromCharCode(wordFromCodePoints[1]) + String.fromCharCode(wordFromCodePoints[2]) + String.fromCharCode(wordFromCodePoints[3]); // Your code here

// Task 3
let inputString2 = "Launch";
let firstLetter = inputString2.charCodeAt(0);
let lastLetter = inputString2.charCodeAt(inputString2.length - 1);
let middleSt = inputString2.slice(1,5);
let swappedString = String.fromCharCode(lastLetter) + middleSt + String.fromCharCode(firstLetter);// Your code here
